...
const CreatedAdmins = ({ userId }) => {
  ...
  const fetchCreatedAdmins = async () => {
    try {
      const response = await apiClient.get("/admin/users/created-admins", {
        params: { userId },
      });
  ...
  const handleDetails = (user) => {
    ...
    navigate(targetPath, { state: { userId: user.id } });
  };
  ...
  return (
    <div className="created-admins-container">
      {selectedUsers.length > 0 &&
        !selectedUsers.some(
          (user) => user.role === "Admin" && !user.isCreator
        ) && (
          <button
            className="created-admins-bulk-delete"
      ...
      <DataTable
        ...
        className="created-admins-table"
      ...
      >
        ...
        <Column
          ...
          body={(rowData) => (
            <button
              className="created-admins-details-button"
        ...
        <Column
          ...
          body={(rowData) => {
            ...
            return (
              ...
              >
                <button
                  className="created-admins-delete-button"
