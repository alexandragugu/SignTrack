...
public class GenericCardAdapter extends AbstractCardProductAdapter {
    ...
    protected SignatureTokenConnection connect(final NexuAPI api, final DetectedCard card, final PasswordInputCallback callback) {
        System.out.println("DEBUG >> Env: " + api.getEnvironmentInfo());
        System.out.println("DEBUG >> Info: " + this.info);
        System.out.println("DEBUG >> ConnInfo: " + this.info.getConnectionInfo(api.getEnvironmentInfo()));
        ...
        switch (scApi) {
            ...
            case PKCS_11:
                ...
                System.out.println("MI-A GASIT PKCS_11: " + absolutePath);
                return new Pkcs11SignatureTokenAdapter(new File("C:\\Windows\\System32\\asepkcs.dll"), callback, card.getTerminalIndex());
